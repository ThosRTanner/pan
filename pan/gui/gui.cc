...
void GUI :: do_show_selected_article_info ()
{
  ...
  if (a != 0)
  {
    ...
    *msg = '\0';
    ...
    const char* author = iconv_inited ? g_mime_iconv_strdup(conv, a->author.c_str()) : a->author.c_str();
    const char* subject = iconv_inited ? g_mime_iconv_strdup(conv, a->subject.c_str()) : a->subject.c_str();
